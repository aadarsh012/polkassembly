	...
	return (
		<Grid>
			<Grid.Column className={className} mobile={16} tablet={12} computer={12} largeScreen={10} widescreen={10}>
				...
				{!email_verified && <div className='errorText'>Please set and verify an email <Link href="/settings">in your settings</Link> to receive be able to set notifications.</div>}
