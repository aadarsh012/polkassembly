		...
		<div className={className}>
			...
			<Grid stackable reversed='mobile tablet'>
				<Grid.Column mobile={16} tablet={16} computer={10}>
					...
					<Link href='/referenda'>
						<a className='full-listing-link'>
							<Icon name='arrow right'/>See all referenda
						</a>
					</Link>
					...
					<Link href='/proposals'>
						<a className='full-listing-link'>
							<Icon name='arrow right'/>See all proposals
						</a>
					</Link>
					...
					<Link href='/motions'>
						<a className='full-listing-link'>
							<Icon name='arrow right'/>See all motions
						</a>
					</Link>

					<h3>Treasury proposals</h3>
					<TreasuryContainer className='treasuryContainer' limit={limit} />
					<Link href='/treasury-proposals'>
						<a className='full-listing-link'>
							<Icon name='arrow right'/>See all treasury proposals
						</a>
					</Link>

					<h3>Technical Committee Proposals</h3>
					<TechCommitteeProposalsContainer className='techCommitteeProposalsContainer' limit={limit} />
					<Link href='/tech-comm-proposals'>
						<a className='full-listing-link'>
							<Icon name='arrow right'/>See all technical committee proposals proposals
						</a>
					</Link>
					...
					<Link href='/tips'>
						<a className='full-listing-link'>
							<Icon name='arrow right'/>See all tips
						</a>
					</Link>
					...
					<Link href='/bounties'>
						<a className='full-listing-link'>
							<Icon name='arrow right'/>See all bounties
						</a>
					</Link>
				</Grid.Column>
